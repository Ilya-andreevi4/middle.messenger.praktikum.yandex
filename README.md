...
Проект представляет из себя мессенджер с возможностью создания чатов и добавления в чаты других юзеров по их ID. Вскоре добавлю возможность отправки файлов.
